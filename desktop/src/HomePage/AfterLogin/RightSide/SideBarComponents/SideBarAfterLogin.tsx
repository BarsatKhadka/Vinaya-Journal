    ...
    return (
        ...
        >
            <div className="flex flex-col gap-2 mt-2 flex-grow">
                ...
                <button onClick={() => setSelectedSidebar('Mood Insights')} className="flex items-center gap-3 px-3 py-2 rounded-md text-[#2F4F4F] font-serif text-base hover:bg-[#e0f2ef] transition-all w-full cursor-pointer">
