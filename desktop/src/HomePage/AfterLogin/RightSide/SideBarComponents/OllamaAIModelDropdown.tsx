    ...
    return (
        <div>
            ...
            >
                ...
                <div className="w-full px-3 py-4 rounded-md border border-red-200 bg-gradient-to-r from-red-50 to-orange-50 text-red-700 font-serif text-sm text-center shadow-sm flex flex-col items-center gap-2">
                <AlertTriangle className="w-6 h-6 text-red-400 mb-1" />
                <div className="font-semibold text-base text-red-700">Ollama is not running</div>
                <div className="text-xs text-red-600">Start Ollama to select a model and chat with AI.</div>
                <Link to="/">
                <p className="mt-2 px-4 py-1.5 rounded bg-red-100 text-red-700 font-medium hover:bg-red-200 transition cursor-pointer">
