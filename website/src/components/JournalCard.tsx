  ...
  return (
    ...
    >
      <div className="rounded-3xl bg-white/60 backdrop-blur-lg flex flex-col items-center justify-center w-full h-full overflow-hidden">
        ...
        <div className="flex items-center justify-between px-4 py-2 w-full rounded-t-3xl bg-white border-b border-amber-200/40">
          <div className="flex items-center gap-2">
            <span className="w-3 h-3 rounded-full bg-red-400 inline-block border border-red-300" />
            <span className="w-3 h-3 rounded-full bg-yellow-300 inline-block border border-yellow-200" />
            <span className="w-3 h-3 rounded-full bg-green-400 inline-block border border-green-300" />
          </div>
          <div className="flex items-center">
            <span className="bg-[#fae4b2] border border-amber-200/60 rounded-lg px-3 py-1 flex items-center shadow-sm">
              <span className="text-green-700 font-bold mr-2">$</span>
              <span className="text-gray-700 font-mono text-xs md:text-sm select-none">cd /VinayaJournal/</span>
              <span className="ml-2 text-vinayaGreen font-mono text-xs md:text-sm select-none">{featureNames[selectedFeature]}</span>
            </span>
          </div>
        </div>
        {/* Image area */}
